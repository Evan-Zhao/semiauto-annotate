...
from labelme_base.utils import init_config
from labelme_client import __appname__, __version__
from labelme_client.application import Application
from labelme_client.config import config_folder, Config
from labelme_client.logger import logger
from labelme_client.mainwindow import MainWindow
from labelme_client.utils.qt import newIcon
...
def main():
    ...
    init_config(
        ...
        config_file=None if use_default_config else config_file
    )

    if not Config.get('labels') and Config.get('validate_label'):
